...
|:-----:|:---------|
| 🟦 | **IBM** (Cognitive Class) |
| 🟨 | **Google** (Developers, Cloud Skills Boost, Skillshop) |
| 🟩 | **Microsoft** (Learn, freeCodeCamp partnership) |
| 🟧 | **AWS** (Educate, Skill Builder) |
| 🔴 | **Cisco** (Skills for All, NetAcad) |
| 🟣 | **Harvard** (CS50) |
| 🩵 | **freeCodeCamp** |
| 🐱‍💻 | **Kaggle** |
| 🧡 | **Anthropic** |
| 🩶 | **DeepLearning.AI / Great Learning / Others** |
...
| 🧡 Anthropic | Claude Code in Action | 🔴 Advanced | 5h | [anthropic.skilljar.com](https://anthropic.skilljar.com/claude-code-in-action) |
...
Microsoft runs **30-day learning sprints** tied to events like *Microsoft Ignite* and *Microsoft Build*. Complete the designated learning path within the window → they email you a **100% off exam voucher** for an official certification.
...
Attending online **AWS Summit** events or **AWSome Days** often yields **50–100% off exam vouchers**. The **AWS Community Builders** program goes further — accepted members receive free certification vouchers as part of the program benefits.
...
If you have a valid **`.edu` email address**, this is non-negotiable. The pack provides massive premium access to developer tools, free domains, and periodically drops **free certification vouchers** for platforms like Educative, DataCamp, and Microsoft Learn.
...
1. Fork the repo
2. Add your entry to the appropriate category table, following the existing column format
3. Ensure the credential is **both** free to learn **and** free to earn (no paywall on the certificate itself)
4. Submit a Pull Request with a brief description

> [!IMPORTANT]
> **Quality Standard:** Please only submit credentials that issue a verifiable, shareable badge, certificate, or trophy at zero cost. "Free audit" courses without a free credential do not qualify (the Hardware Security note above is the sole exception, flagged explicitly).
